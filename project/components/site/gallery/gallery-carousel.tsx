          ...
          <div className="flex">
            {items.map((item, index) => (
              <div
                ...
                className="relative flex min-w-0 shrink-0 grow-0 basis-[52%] justify-center pe-2 sm:basis-[38%] sm:pe-3 md:basis-[32%] lg:basis-[26%]"
              >
                <button
                  type="button"
                  ...
                  className="group relative aspect-[3/2] w-full max-w-[280px] cursor-pointer overflow-hidden rounded-[var(--radius-md)] border border-border bg-surface-raised shadow-sm transition-colors hover:border-accent focus-visible:ring-2 focus-visible:ring-accent focus-visible:outline-none sm:max-w-none"
                >
                  <GalleryMediaThumb
                    item={item}
                    sizes={SIZES}
                  ...
                  {item.mediaType === "IMAGE" ? (
                    <span className="pointer-events-none absolute end-2 top-2 rounded-[var(--radius-sm)] border border-border bg-bg/80 px-2 py-0.5 text-[11px] font-medium text-fg opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100">
                      {viewLabel}
                    </span>
                  ) : null}
                </button>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "flex size-9 items-center justify-center rounded-full border border-border bg-bg/85 text-fg backdrop-blur-sm sm:size-10",
